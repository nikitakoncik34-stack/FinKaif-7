...
Для type="expense":
  ...
  🛒 Продукты
    Торговые точки: Пятёрочка, Магнит, Перекрёсток, ВкусВилл, Дикси, Лента, Ашан, О'КЕЙ, Атак,
      Метро (гипермаркет), Spar, Billa, Азбука вкуса, Eurospar, Мираторг
    Доставка: СберМаркет, Самокат, Яндекс.Лавка, Яндекс Лавка, Доброцен, iGooods
    Ключевые слова: "продукты", "grocery", "food", "универсам", "гастроном", "супермаркет", "продовольственный"
    ВАЖНО: Wildberries, Ozon, Lamoda — это 🛍️ Одежда и шопинг, а НЕ продукты!

  ☕ Кафе и рестораны
    Рестораны: McDonald's, Макдоналдс, KFC, Burger King, Subway, Чайхана, Якитория, Суши Wok, Сушкоф
    Кофейни: Starbucks, Кофемания, Coffeemania, Шоколадница, Coffee Like, Cofix, Lavazza, Surf Coffee
    Доставка еды: Яндекс.Еда, Delivery Club, DoDo Pizza, Додо Пицца, Domino's Pizza
    Фастфуд: Теремок, Крошка Картошка, Sbarro, Burger Heroes
    Ключевые слова: "cafe", "кафе", "ресторан", "pizza", "пицца", "суши", "бар", "столовая", "фастфуд", "sushi"

  🚗 Транспорт
    Такси: Яндекс Такси, Яндекс Go, Яндекс.Такси, Uber, Ситимобил, inDriver, Gett
    Каршеринг: Яндекс Драйв, BelkaCar, Делимобиль, CAR5, YouDrive
    Общественный транспорт: Метро, Электричка, МЦД, МЦК, Тройка, ОАО РЖД (пригородное)
    Авиа и ж/д: РЖД, Аэрофлот, S7 Airlines, Ютэйр, Победа, Smartavia, авиабилеты, железнодорожные билеты
    АЗС: Газпромнефть, Лукойл, Роснефть, Shell, BP, АЗС
    Парковки: Московская парковка, ПАО Сбер Парковки, EasyPark
    Ключевые слова: "такси", "taxi", "каршеринг", "автобус", "метро", "транспорт", "парковка", "avia", "авиа"

  💻 Сервисы и подписки
    Стриминг: Netflix, Нетфликс, YouTube Premium, Spotify, Apple Music, IVI, Okko, Кинопоиск, START
    Яндекс-сервисы: Яндекс Плюс, Яндекс 360, Яндекс Диск, Яндекс.Музыка
    Мобильная связь: МТС, Билайн, МегаФон, Tele2, Ростелеком, МГТС, Yota
    Интернет: Дом.ру, ТТК, NetByNet
    ПО и подписки: Microsoft 365, Adobe, Google One, 1С, антивирус, Kaspersky, VPN
  ...
  💊 Здоровье и аптеки
    Аптеки: Аптека, 36.6, Ригла, Самсон-Фарма, Горздрав, Farmacy, Аптека низких цен, Планета Здоровья
  ...
  🛍️ Одежда и шопинг
    ...
    Одежда: Zara, H&M, Uniqlo, Adidas, Nike, Спортмастер, Columbia, Декатлон, Befree
    Косметика: Л'Этуаль, Рив Гош, Sephora, Brocard, YVES ROCHER
    Электроника: DNS, М.Видео, Эльдорадо, re:Store, Apple Store, iStore
  ...
  🎉 Развлечения
    ...
    Спорт и хобби: Боулинг, Квест-комната, Картинг, Аквапарк, Фитнес-клуб, World Class, SportMaster
    Концерты: Билетер, Kassir.ru, Ticketmaster, Eventim, Яндекс Афиша
    Ключевые слова: "кино", "театр", "развлечение", "фитнес", "спорт", "билет", "концерт", "игра", "квест"
